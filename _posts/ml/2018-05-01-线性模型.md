...
# logistic 分类
![](https://ws2.sinaimg.cn/large/006tNbRwgy1fve1x9atycj31i8116ah0.jpg)
普通回归模型套一个 **sigmoid** function 控制输出 (0,1)
![](https://ws2.sinaimg.cn/large/006tNbRwgy1fve1z8vkf4j31hw11oter.jpg)
- softmax
```python
def softmax(X):
    exps = np.exp(X)
...
![](https://ws4.sinaimg.cn/large/006tNbRwgy1fvfv2wsvs1j306u02ymwy.jpg)
![](https://ws1.sinaimg.cn/large/006tNbRwgy1fvfuwk0a4sj30qa06at8r.jpg)
![](https://ws4.sinaimg.cn/large/006tNbRwgy1fvfuwo7ap6j31iy0l0abq.jpg)
![](https://ws4.sinaimg.cn/large/006tNbRwgy1fvfuwy25f7j317e08amxm.jpg)
- cross entry
```python
