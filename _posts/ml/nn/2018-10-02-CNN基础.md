...
![](https://tva4.sinaimg.cn/large/006tNc79gy1fvtrpf66nbj31e60pmjsq.jpg)
...
![](https://tva3.sinaimg.cn/large/006tNc79gy1fvtpo29rmdj30um0qowgf.jpg)
卷积用conv_forward()表示；tensorflow中，卷积用tf.nn.conv2d()表示；keras中，卷积用Conv2D()表示。

## 边缘检测example
<span class='gp-2'>
    <img src='https://tva4.sinaimg.cn/large/006tNc79gy1fvtpz3njfaj30va0m8mxt.jpg' />
    <img src='https://tva1.sinaimg.cn/large/006tNc79gy1fvtq0ea7d0j30pk0fyq3g.jpg' />
</span>
...
![](https://tva2.sinaimg.cn/large/006tNc79gy1fvtqy5wo1hj31ii0oqwfy.jpg)
...
![](https://tva4.sinaimg.cn/large/006tNc79gy1fvtrkn0kjaj31jk0rwjst.jpg)

# 单层卷积网络（One layer of a convolutional network）
![](https://tva2.sinaimg.cn/large/006tNc79ly1fvtsfeb97wj31iq0rkabi.jpg)
...
![](https://tva1.sinaimg.cn/large/006tNc79gy1fvtyn5wgmij30nb06xmxa.jpg)
...
<span class='gp-2'>
    <img src='https://tva3.sinaimg.cn/large/006tNbRwgy1fwbkdp5wnqj31kw0jr0vo.jpg' />
    <img src='https://tva3.sinaimg.cn/large/006tNbRwgy1fwbkegrgerj31co0o4779.jpg' />
</span>
...
![](https://tva3.sinaimg.cn/large/006tNc79gy1fvtz4k5tctj30dt0600sr.jpg)

Max pooling的好处是**只保留区域内的最大值**（特征），忽略其它值，**降低noise**影响，提高模型健壮性。
而且，max pooling需要的超参数仅为滤波器尺寸f和滤波器步进长度s，没有其他参数需要模型训练得到，**计算量很小**。
<span class='gp-2'>
    <img src='https://tva1.sinaimg.cn/large/006tNc79gy1fvtzfb870zj31kw0l7acn.jpg' />
    <img src='https://tva2.sinaimg.cn/large/006tNc79gy1fvtzgavx0aj31gy0sejvf.jpg' />
</span>

# 1x1 Convolutions
filter的维度为1x1，可以用来缩减channel数目,获得filter个数的channel数，池化层压缩它的高度和宽度
![](https://tva4.sinaimg.cn/large/006tNc79ly1fvut9u9dypj30sa0dgaa4.jpg)

# Inception network motivation
代替人工来确定卷积层中的过滤器类型，或者确定是否需要创建卷积层或池化层
![](https://tva4.sinaimg.cn/large/006tNbRwly1fvutt80pzgj30mv08ejrp.jpg)
Inception Network使用不同尺寸的filters并将CONV和POOL混合起来，将所有功能输出组合拼接，再由神经网络本身去学习参数并选择最好的模块。

提升性能的同时，计算量大。
<span class='gp-2'>
    <img src='https://tva2.sinaimg.cn/large/006tNbRwly1fvutunc7xnj30cz06bwei.jpg' />
    <img src='https://tva2.sinaimg.cn/large/006tNbRwly1fvutuqfxkbj30va09nmxl.jpg' />
</span>
...
<span class='gp-3'>
    <img src='https://tva1.sinaimg.cn/large/006tNbRwgy1fvv51iomjzj30s00o6my2.jpg' />
    <img src='https://tva2.sinaimg.cn/large/006tNbRwgy1fvv51qy6bwj30wa0pmmyj.jpg' />
    <img src='https://tva1.sinaimg.cn/large/006tNbRwgy1fvv5200h6vj30wa0s0wf4.jpg' />
</span>