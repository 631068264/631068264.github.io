...
```sh
openssl req -x509 -sha256 -nodes -days 36500 -newkey rsa:2048 -keyout harbor.key -out harbor.crt -subj "/CN=harbor.xxxx.cn" -addext "subjectAltName = DNS:harbor.xxxx.cn"
```
...
```
echo "xxx.xxx.xx.205 harbor.xxxx.cn" >> /etc/hosts
```
...
![image-20220519111824934](https://tva1.sinaimg.cn/large/e6c9d24egy1h33kjs6sl8j22630u0n0o.jpg)
...
```sh
openssl req -x509 -sha256 -nodes -days 36500 -newkey rsa:2048 -keyout tls.key -out tls.crt -subj "/CN=205.xxxx.cn" -addext "subjectAltName = DNS:205.xxxx.cn"
...
![image-20220606161846013](https://tva1.sinaimg.cn/large/e6c9d24egy1h33kjtmglmj227y0tajw0.jpg)
...
![image-20220606162818445](https://tva1.sinaimg.cn/large/e6c9d24egy1h33kjssse7j21yb0u00xt.jpg)
...
- 配置填写
  ...
  ![image-20220606163428904](https://tva1.sinaimg.cn/large/e6c9d24egy1h33kju2osuj21uu0qq78q.jpg)
...
helm install rancher-backup rancher-backup-2.1.2.tgz -n cattle-resources-system  --set "image.repository=harbor.xxxx.cn:4443/rancher/backup-restore-operator"
```
