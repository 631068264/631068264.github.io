...
![image-20220122173734993](https://tva1.sinaimg.cn/large/008i3skNgy1gyml4tdw5wj30wb0u0jtl.jpg) 
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymlkgiztsj30ow0hpdhn.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymlo16ukjj30m50dmdgz.jpg)
...
从类型上来看，Volume Plugins 可以分为很多种。In-Tree 中就包含了 几十种常见的存储实现，但一些公司的自己定义私有类型，有自己的 API 和参数，公共存储插件是无法支持的，这时就需要 Out-of-Tree 类的存储实现，比如 CSI、FlexVolume。
 ...
 ![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymlqc4wn0j30hx0c5t9x.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymlrj5r9xj314i0ddmz2.jpg)
...
![image-20220122191535836](https://tva1.sinaimg.cn/large/008i3skNgy1gymnyttp72j315a0hoq57.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymluh0apbj30u20bxabs.jpg)
...
![image-20220122192053352](https://tva1.sinaimg.cn/large/008i3skNgy1gymo4ay98xj31em0smgr4.jpg)
...
从挂载流程和卸载流程两个方向来分析 Flexvolume 的挂载过程。
 ...
 ![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymqcqaa78j30lm0h475x.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymqut6eaoj30mw0hegnl.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymr4poim0j31680ly0yv.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymrt6j4x7j30yr0h177p.jpg)
...
下面是一个具体的运行结果。在 Pod 内部我们挂载了一个云盘，其所在本地设备为 /dev/vdb。通过 mount | grep disk 我们可以看到相应的挂载目录，首先它会将 /dev/vdb 挂载到 GlobalPath 中；其次会将 GlobalPath 通过 mount 命令挂载到一个 Pod 所定义的本地子目录中去；最后会把该本地子目录映射到 /data 上。
 ...
 ![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymrtmdjc3j30y705j3zm.jpg)
...
![image-20221004112609766](https://tva1.sinaimg.cn/large/006y8mN6gy1h6t3ravpxnj31es0u0afn.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymtd1wol4j30lx0avmy0.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymte2g3kgj30ji0mnq79.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymu2ia5nhj30xc0dhgny.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymu2xok6yj30kx087dhd.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymu44bcx7j30ew09lwfe.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymu7ywljrj30g009qt9r.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymu8i0z8uj30qd09h40h.jpg)

## CSI 组件之 Node-Driver-Registrar

Node-Driver-Registrar 主要实现了 CSI Plugin 注册的一个机制。我们来看一下下图中的流程图。

![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymu8zsr71j30v90jn76d.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymuavsoqmj31330i9q5o.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymusfexzyj31770d9n04.jpg)

文件存储和块存储的部署情况是类似的。只不过它会把 Attacher 去掉，也没有 VolumeAttachment 对象。

 

![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymv1jmj5yj314s0clwgk.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymv2bmqe4j31160jbq72.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymv2nfxj7j312x068wfw.jpg)
...
![img](https://tva1.sinaimg.cn/large/008i3skNgy1gymv3d51ibj314v0n4dn5.jpg)
