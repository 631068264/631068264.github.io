...
https://10.19.64.201:1443/k8s/clusters/{cluster-id}/api/v1/namespaces/{namespace}/services/{svc}:{svc-port-name}/proxy

# k8s proxy api
/api/v1/namespaces/{namespace}/services/{svc}:{svc-port-name}/proxy

https://10.19.64.201:1443/k8s/clusters/c-xlfq6/api/v1/namespaces/istio-system/services/istio-ingressgateway:http2/proxy/v1/models/xx:predict
```
