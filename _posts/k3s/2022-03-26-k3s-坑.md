...
```sh
kubectl patch  deploy cattle-cluster-agent -n cattle-system --type='merge' -p '{"spec":{"template":{"spec":{"hostAliases":[{"ip":"10.19.64.205","hostnames":["域名"]}]}}}}
```
